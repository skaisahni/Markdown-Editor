# MarkDwon Editor application  using React,Javascript ,css , html, Marked.js #
...
* app.css  for styling of pages;
* app.js for formatting and styling logic to perform task;
